...
<h3>Manage <medium> ROLES</medium>
 <a id="addlink" href='<?php echo Yii::app()->createUrl("role/create",array("asDialog"=>1));?>'><i class="icon-plus"></i></a>
</h3>
<hr>
	...
	'columns'=>array(
		...
		'rtitle',
			array(
					...
					'buttons' => array(
							'view' => array(
									'url'=>'Yii::app()->createUrl("role/view", array("id"=>$data->id,"asDialog"=>1))',
									'click'=>"function(){
								    $.fn.yiiGridView.update('role-grid', {  //change my-grid to your grid's name
								        type:'GET',
								        url:$(this).attr('href'),
										beforeSend : function() {
											           $('#content').addClass('ajaxloading');
							...
							'update' => array(
									'url'=>'Yii::app()->createUrl("role/update", array("id"=>$data->id,"asDialog"=>1))',
									'click'=>"function(){
								    $.fn.yiiGridView.update('role-grid', {  //change my-grid to your grid's name
								        type:'GET',
								        url:$(this).attr('href'),

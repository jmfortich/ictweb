...
Yii::app()->clientScript->registerScript('submenu_ajax', "
	...
	");
?>
<h3>Update <medium>DOCUMENT <?php echo $model->id; ?></medium>&nbsp;
<a class="ajaxlink" href="<?php echo Yii::app()->createUrl("docViewer/document/create",array("asDialog"=>1))?>"><i class="icon-plus"></i></a> &nbsp;
<a class="ajaxlink" href="<?php echo Yii::app()->createUrl("docViewer/document/view",array('id'=>$model->id))?>"><i class="icon-list-alt"></i></a>&nbsp;

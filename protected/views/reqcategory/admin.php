...
<h3>Manage <medium> REQUEST CATEGORIES</medium>
 <a id="addlink" href='<?php echo Yii::app()->createUrl("reqcategory/create",array("asDialog"=>1));?>'><i class="icon-plus"></i></a>
</h3>
 <hr>
	...
	'columns'=>array(
		...
		array(
			'class'=>'CButtonColumn',
				...
				'buttons' => array(
						'view' => array(
								'url'=>'Yii::app()->createUrl("reqcategory/view", array("id"=>$data->id,"asDialog"=>1))',	
								'click'=>"function(){
								    $.fn.yiiGridView.update('reqcategory-grid', {  //change my-grid to your grid's name
								        type:'GET',
								        url:$(this).attr('href'),
										beforeSend : function() {
											           $('#content').addClass('ajaxloading');
						...
						'update' => array(
								'url'=>'Yii::app()->createUrl("reqcategory/update", array("id"=>$data->id,"asDialog"=>1))',
								'click'=>"function(){
								    $.fn.yiiGridView.update('reqcategory-grid', {  //change my-grid to your grid's name
								        type:'GET',
								        url:$(this).attr('href'),

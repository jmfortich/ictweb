...
<h3>Manage <medium> STATUSES</medium>
 <a id="addlink" href='<?php echo Yii::app()->createUrl("status/create",array("asDialog"=>1));?>'><i class="icon-plus"></i></a>
</h3>
<hr>
	...
	'columns'=>array(
		...
		array(
			'class'=>'CButtonColumn',
				...
				'buttons' => array(
						'view' => array(
								'url'=>'Yii::app()->createUrl("status/view", array("id"=>$data->id,"asDialog"=>1))',	
								'click'=>"function(){
								    $.fn.yiiGridView.update('status-grid', {  //change my-grid to your grid's name
								        type:'GET',
								        url:$(this).attr('href'),
										beforeSend : function() {
											           $('#content').addClass('ajaxloading');
						...
						'update' => array(
								'url'=>'Yii::app()->createUrl("status/update", array("id"=>$data->id,"asDialog"=>1))',
								'click'=>"function(){
								    $.fn.yiiGridView.update('status-grid', {  //change my-grid to your grid's name
								        type:'GET',
								        url:$(this).attr('href'),

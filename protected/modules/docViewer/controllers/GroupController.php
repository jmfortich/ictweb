...
class GroupController extends Controller
{
	...
	{
		$dataProvider=new Usergroup('search');
		$dataProvider->unsetAttributes();  // clear any default values
		if(isset($_GET['Usergroup']))
			$dataProvider->attributes=$_GET['Usergroup'];
		$dataProvider->groupid=$id;
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Group']))
		{
			...
			if($model->save()){
				Yii::app()->user->setFlash('info','New group was successfully added!');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Group']))
		{
			$model->attributes=$_POST['Group'];
			if($model->save()){
				Yii::app()->user->setFlash('info','Group was successfully updated!');				
				$this->redirect(array('admin'));
			}
		}

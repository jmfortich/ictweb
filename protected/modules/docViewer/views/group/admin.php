...
<h3>Manage <medium>GROUPS</medium>
	...
	'columns'=>array(
		...
		array(
			...
			'buttons' => array(
						...
						'update' => array(
								'url'=>'Yii::app()->createUrl("docViewer/group/update", array("id"=>$data->id,"asDialog"=>1))',
								'click'=>"function(){
								    $.fn.yiiGridView.update('group-grid', {  //change my-grid to your grid's name
								        type:'GET',
								        url:$(this).attr('href'),
										beforeSend : function() {
											           $('#content').addClass('ajaxloading');

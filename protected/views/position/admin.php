...
<h3>Manage <medium>POSITIONS</medium>
 <a id="addlink" href='<?php echo Yii::app()->createUrl("position/create",array("asDialog"=>1));?>'><i class="icon-plus"></i></a>
</h3> 
<hr>
	...
	'columns'=>array(
		...
		array(
			'class'=>'CButtonColumn',
				...
				'buttons' => array(
						'view' => array(
								'url'=>'Yii::app()->createUrl("position/view", array("id"=>$data->id,"asDialog"=>1))',	
								'click'=>"function(){
								    $.fn.yiiGridView.update('position-grid', {  //change my-grid to your grid's name
								        type:'GET',
								        url:$(this).attr('href'),
										beforeSend : function() {
											           $('#content').addClass('ajaxloading');
						...
						'update' => array(
								'url'=>'Yii::app()->createUrl("position/update", array("id"=>$data->id,"asDialog"=>1))',
								'click'=>"function(){
								    $.fn.yiiGridView.update('position-grid', {  //change my-grid to your grid's name
								        type:'GET',
								        url:$(this).attr('href'),

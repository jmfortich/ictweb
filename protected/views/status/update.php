...
<h3>Update <medium>STATUS <?php echo $model->id; ?></medium>&nbsp;
<a class="ajaxlink" href="<?php echo Yii::app()->createUrl("status/create",array("asDialog"=>1))?>"><i class="icon-plus"></i></a> &nbsp;
<a class="ajaxlink" href="<?php echo Yii::app()->createUrl("status/view",array('id'=>$model->id))?>"><i class="icon-list-alt"></i></a>&nbsp;

...
<h3>Update <medium>REQUEST <?php echo $model->id; ?></medium>&nbsp;
<!-- 
<a class="ajaxlink" href="<?php echo Yii::app()->createUrl("request/create",array("asDialog"=>1))?>"><i class="icon-plus"></i></a> &nbsp;
<a class="ajaxlink" href="<?php echo Yii::app()->createUrl("request/view",array('id'=>$model->id))?>"><i class="icon-list-alt"></i></a>&nbsp;
 -->

...
<h3>Update <medium>BRANCH <?php echo $model->brcode; ?></medium>&nbsp;
<a class="ajaxlink" href="<?php echo Yii::app()->createUrl("branch/create",array("asDialog"=>1))?>"><i class="icon-plus"></i></a> &nbsp;
<a class="ajaxlink" href="<?php echo Yii::app()->createUrl("branch/view",array('id'=>$model->id))?>"><i class="icon-list-alt"></i></a>&nbsp;

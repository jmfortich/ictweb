...
<h3>Update <medium>REQUEST CATEGORY <?php echo $model->id; ?></medium>&nbsp;
<a class="ajaxlink" href="<?php echo Yii::app()->createUrl("reqcategory/create",array("asDialog"=>1))?>"><i class="icon-plus"></i></a> &nbsp;
<a class="ajaxlink" href="<?php echo Yii::app()->createUrl("reqcategory/view",array('id'=>$model->id))?>"><i class="icon-list-alt"></i></a>&nbsp;
